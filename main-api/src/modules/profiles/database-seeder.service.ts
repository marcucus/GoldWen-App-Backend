...
export class DatabaseSeederService implements OnModuleInit {
  ...
  private async seedPersonalityQuestions() {
    ...
    const questions = [
      {
        question: "Quel type d'activité préférez-vous pour un premier rendez-vous ?",
      ...
      {
        question: "Sur une échelle de 1 à 10, à quel point êtes-vous spontané(e) ?",
      ...
      {
        question: "Quelle importance accordez-vous à la famille dans votre vie ?",
        type: QuestionType.SCALE,
        minValue: 1,
        maxValue: 10,
        order: 4,
